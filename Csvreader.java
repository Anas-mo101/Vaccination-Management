...
public class Csvreader {
    ...
    public Boolean CheckLoginDetails(String ID, String Pass, String Usertype){
        for (int i = 0; i < UsersInfo.size(); i++) {
            ...
            String pass = items[1];   
            String usertype = items[2];                            //  items[3] is username , items[4] is 1st vac status, items[5] is 2nd vac status 
            if(ID.equals(id)){
                if(Pass.equals(pass)){
    ...
    public void addUser( String Pass, String Usertype, String Username, Boolean FstVac, Boolean ScndVac, String Phone){    // adds new user
        ...
        try {
            ...
            writer.append("\n" + Last_ID + "," + Pass + "," + Usertype + "," + Username + "," + FstVac + "," + ScndVac + ",none,none," + Phone + ",none,");
            writer.close();
    ...
    public void GetUserInfoByID(String ID){      // gets all user info by ID
        for (int i = 0; i < UsersInfo.size(); i++) {
            ...
            String id = items[0];                                  
            if(ID.equals(id)){
                    System.out.println("User ID: " + ID + ", Name: " + GetUserData(NAME_INDEX,i)  + ", First Vaccine Status: " + GetUserData(FSTSTATUS_INDEX,i) + ", Second Vaccine Status: " + GetUserData(SCNDSTATUS_INDEX,i) 
                    + ", First Appoinment: " + GetUserData(FIRSTVAC_INDEX,i) + ", Second Appoinment: " + GetUserData(SCNDVAC_INDEX,i) + ", Phone: " + GetUserData(PHONE_INDEX,i));
                }
            }
    }
